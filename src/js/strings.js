...
안녕하세요, 크레타입니다!
혹시, 이 도구를 사용하는 게 처음이신가요? 어렵지 않습니다!

폰트 제작 워크플로우는 이렇습니다.

1. AngelCode사의 BMFont를 이용해서 fnt 파일을 만듭니다.
   (사용하고 싶은 한글의 글자들을 모두 넣으세요!)
2. 이 페이지에서 도깨비한글 템플릿을 받은 후,
   양식에 맞춰서 가로 30, 세로 18칸으로 나뉘는 도깨비한글 폰트를 이미지로 그리세요.
3. fnt와 스프라이트 시트, 도깨비한글 스프라이트를 모두 넣고 합치기를 누릅니다.
4. 폰트에서 수정해야 할 부분이 보인다면...
   도깨비한글 파일만 다시 올리고 합치기를 눌러서 수정한 부분들을 볼 수 있어요!`
};